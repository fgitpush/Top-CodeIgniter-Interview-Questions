...
| | [Why is CodeIgniter called a loosely based MVC framework?](#What-is-Vertical-scaling) |  
| | [Explain the folder structure of CodeIgniter.](#What-is-Vertical-scaling) |  
| | [ Explain CodeIgniter architecture.](#What-is-Vertical-scaling) |  
| | [What are the most prominent features of CodeIgniter?](#What-is-Vertical-scaling) |
| | [Explain what is inhibitor in CodeIgniter?](#What-is-Vertical-scaling) |
| | [How to access config variable in codeigniter?](#What-is-Vertical-scaling) |  
| | [Explain CodeIgniter folder structure.](#What-is-Vertical-scaling) |  
|   | **CONSTRUCTOR** |  
| | [How do you call a constructor in codeigniter?](#what-is-composer) |
|   | **MYSQL and ORM** |  
| | [ How does the Codeigniter generate raw queries?](#which-is-error-management) |  
|| [ What command is used to connect models to the database manually?](#Explain-an-apps-DB-architecture) | 
| | [ Can you load multiple helper functions in a single command in Codeigniter? If so, how?](#Describe-design-architecture-of-an-app) |  
|| [ How can you connect models to a database manually?](#Explain-AWS-Services) |  
| | [ How to print SQL statement in codeigniter model?](#What-is-Horizontal-scaling) |  
| | [How do you get last inserted ID in Codeigniter?](#What-is-Vertical-scaling) |  
| | [Explain how you will load or add a model in CodeIgniter?](#What-is-Vertical-scaling) |  
| | [List various databases supported by the CodeIgniter framework.](#What-is-Vertical-scaling) |  
| | [How can you print SQL statement in CodeIgniter model?](#What-is-Vertical-scaling) | 
|| [  How is a record deleted in Codeigniter?](#what-are-payments-and-cashier) |  
| | [Explain ORM and list all the ORM in Codeigniter.](#what-is-socialite-auth) |  
| | [How can you connect models to a database manually?](#What-is-Vertical-scaling) |  
| | [How to connect multiple databases in CodeIgniter?](#What-is-Vertical-scaling) |  
|   | **Hooks** |  
| | [How do you enable hooks in codeigniter?](#what-are-Popular-composer-packages) |
| | [Explain what are hooks in CodeIgniter?](#What-is-Vertical-scaling) |  
| | [List out different types of hook points in Codeigniter?](#What-is-Vertical-scaling) |  
| | [Give the list of hooks available in CodeIgniter.](#What-is-Vertical-scaling) |
| | [How to enable CodeIgniter hook?](#What-is-Vertical-scaling) |  
| | [What are different types of hook points in CodeIgniter?](#What-is-Vertical-scaling) |  
|   | **What Is** |  
| | [ How are config variables set or get in Codeigniter?](#what-are-laravel-scout-search-and-algolia) |
| | [ What does the is_cli() method does in Codeigniter?](#What--Single-Page-Application-in-Laravel) |  
| | [What is the use of CLI in Codeigniter?](#What-are-Microservices-in-Laravel) |  
| | [ What is the procedure to add/link JavaScript/Images?CSS in Codeigniter?](#what-is-soa) | 
| | [What is the difference between Laravel and CodeIgniter?](#What-is-Vertical-scaling) |  
|   | **How To** |  
|| [ How do you remove index.php from the URL in Codeigniter?](#What-is-ACL-in-laravel) |  
|| [ How is the default timezone set in Codeigniter?](#Why-prefer-Laravel-over-other-frameworks) |  
|   | **Current Versions** |  
| | [ How to check the CodeIgniter version?](#What-is-Vertical-scaling) |  
|   | **Controller** |  
| | [What is the default controller in CodeIgniter?](#What-is-Vertical-scaling) |  
| | [How to pass an array from the controller to view in CodeIgniter?](#What-is-Vertical-scaling) |  
| | [Explain controller in CodeIgniter.](#What-is-Vertical-scaling) |  
|   | **Routing** | 
| | [Mention what is the default URL pattern used in Codeigniter framework?](#What-is-Vertical-scaling) |  
| | [Why is there a need to configure the URL routes?](#What-is-Vertical-scaling) |  
| | [What is routing in CodeIgniter?](#What-is-Vertical-scaling) |  
| | [Why do URL routes need to be configured?](#What-is-Vertical-scaling) |  
| | [ What is routing in CodeIgniter?](#What-is-Vertical-scaling) |  
| | [Mention what is the default URL pattern used in Codeigniter framework?](#What-is-Vertical-scaling) |  
|   | **Helper Functions** |
| | [How to load helpers in CodeIgniter?](#what-is-vue-js) |  
| | ["Extending" Helpers](#What-is-Vertical-scaling) |  
| | [Explain what helpers in CodeIgniter are and how you can load a helper file?](#What-is-Vertical-scaling) |  
| | [Explain the default URL pattern](#What-is-Vertical-scaling) |  
| | [What is a helper in CodeIgniter?](#What-is-Vertical-scaling) |  
| | [ What is a helper in CodeIgniter? How can a helper file be loaded?](#What-is-Vertical-scaling) |  
| | [How can you load multiple helper files?](#What-is-Vertical-scaling) | 
| | [ Explain the difference between helper and library in CodeIgniter.](#What-is-Vertical-scaling) |  
|   | **Sessions** |
| | [What are the sessions in CodeIgniter? ](#What-is-Vertical-scaling) |  
| | [How to handle sessions in CodeIgniter?](#What-is-Vertical-scaling) |  
|   | **Error Handling** |
| | [How to deal with Error handling in CodeIgniter?](#What-is-Vertical-scaling) | 
|   | **Routing** | 
| | [Explain routing in Codeigniter?](#What-is-Vertical-scaling) |  
|   | **URL Structure** | 
| | [What is the basic CodeIgniter URL structure?](#What-is-Vertical-scaling) |  
|   | **CSRF** | 
| | [How can you enable CSRF?](#What-is-Vertical-scaling) |  
| | [Explain how you can prevent CodeIgniter from CSRF?](#What-is-Vertical-scaling) |  
| | [What is a token method in a CSRF attack?](#What-is-Vertical-scaling) | 
| | [What are the XSS security parameters?](#What-is-Vertical-scaling) |  
| | [How can CodeIgniter be prevented from CSRF?](#What-is-Vertical-scaling) |   
| | [Explain how you can enable CSRF (Cross Site Request Forgery) in CodeIgniter?](#What-is-Vertical-scaling) | 
| | [Mention what are the security parameters for XSS in CodeIgniter?](#What-is-Vertical-scaling) |  
|   | **MVC** | 
| | [Explain MVC in CodeIgniter.](#What-is-Vertical-scaling) |  
|   | **Security** | 
| | [What are CodeIgniter security methods?](#What-is-Vertical-scaling) |  
|   | **Driver** | 
| | [What are CodeIgniter drivers?](#What-is-Vertical-scaling) |  
| | [How to initialize a driver in CodeIgniter?](#What-is-Vertical-scaling) |  
| | [How to create a driver in CodeIgniter?](#What-is-Vertical-scaling) | 
| | [ What are drivers in CodeIgniter?](#What-is-Vertical-scaling) |  
|   | **Session** | 
| | [How to set & unset session variable in codeigniter?](#What-is-Vertical-scaling) |  
|   | **Views** | 
| | [Explain views in CodeIgniter?](#What-is-Vertical-scaling) | 
|   | **Lirary** | 
| | [Explain the CodeIgniter library. How will you load it?](#What-is-Vertical-scaling) |  
| | [How can you create a library in CodeIgniter?](#What-is-Vertical-scaling) |  
| | [Where is a newly created library stored in CodeIgniter structure?](#What-is-Vertical-scaling) |  
| | [Can you extend native libraries in CodeIgniter?](#What-is-Vertical-scaling) |  
|   | **General Questions** | 
| | [List all the auto-loadable resources available in CodeIgniter.](#What-is-Vertical-scaling) |  
| | [What is an inhibitor of CodeIgniter?](#What-is-Vertical-scaling) |  
| | [Explain the remapping method calls in CodeIgniter.](#What-is-Vertical-scaling) |  
|   | **Class** | 
| | [How can you extend a class in CodeIgniter?](#What-is-Vertical-scaling) | 
|   | **Views** | 
| | [How to link images from a view in CodeIgniter?](#What-is-Vertical-scaling) |  
| | [Explain how you can link images/CSS/JavaScript from a view in code igniter?](#What-is-Vertical-scaling) |  
